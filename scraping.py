...
# Create a list to hold the image URL string and title for each hemisphere image.
    hemisphere_image_urls = []


# Write code to retrieve the full-resolution image URL and title for each hemisphere image
    img_resolution = browser.find_by_css('a.product-item img')


# 3. Write code to retrieve the image urls and titles for each hemisphere.
    for i in range(len(img_resolution)):
    ...
    # Create a hemispheres dictionary
        hemispheres = {}
    
    # Get hemispheres title and img_url
